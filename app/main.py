...
async def disable_cache_for_html_and_sw(request: Request, call_next):
    ...
    if "text/html" in content_type or path.endswith("sw.js") or path.endswith("sw-push-v22.js") or path.endswith("sw-push-v24.js") or path.endswith("manifest.webmanifest"):
